export const pt = {
  ...
  homeClosing: {
    ...
    body: "Conta um pouco sobre a data, o lugar e o que vocês imaginam. Respondemos com calma, com atenção, e gosto de detalhe.",
    ctaPrimary: "Conversar",
    ctaSecondary: "Ver investimento",
  },
  films: {
    eyebrow: "Portfólio",
  ...
  filmDetail: {
    ...
    backToFilms: "Voltar aos filmes",
    talkAboutOurs: "Conversar sobre o nosso filme",
    openOn: "Abrir no",
  },
  about: {
    eyebrow: "Sobre",
    ...
    bodyP3:
      "Depois, no estúdio, montamos o filme com a mesma paciência. Sem trilha apressada, sem efeito de moda. O resultado é um filme que, em dez ou vinte anos, ainda vai parecer escrito agora.",
    ...
    values: {
      one: {
        label: "01",
        title: "Único",
        body: "Cada casal tem o filme dele. Não usamos modelo, não copiamos a gente mesmo.",
      },
      two: {
        label: "02",
        title: "Poético",
        body: "Imagem que respira. Silêncio quando é silêncio. Música quando faz sentido.",
      },
      three: {
        label: "03",
        title: "Analógico",
        body: "Textura suave, cor calma, grão fino. Sem corre de efeito; com gosto de filme.",
      },
      four: {
        label: "04",
        title: "Atemporal",
  ...
  contact: {
    ...
    whatsappCta: "Converse no WhatsApp",
  },
  footer: {
    tagline:
